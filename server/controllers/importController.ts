...
// import { AuthenticatedRequest } from '../types/express/index.js'; // Больше не используем
import { ParsedQs } from 'qs'; // Для ParsedQs
 ...
 * @returns {Error}
 */
export const getAllImports = async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
 ...
 * @returns {Error}
 */
export const initiateImport = async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
...
export const uploadAndProcessFile = [
  ...
  async (req: Request<{ importId: string }, any, any, ParsedQs>, res: Response, _next: NextFunction): Promise<void> => {
    try {
      ...
      logger.info('[ImportController.uploadAndProcessFile] Attempting to upload and process file. Import ID: %s, User: %s, File: %s',
      ...
      logger.info('[ImportController.uploadAndProcessFile] File processed for import ID: %s. Status: %s',
        importId, result.importRecord?.status);
 ...
 * @returns {Error}
 */
export const executeImport = async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
